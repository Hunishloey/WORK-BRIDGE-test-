...
export default function ManageSkill() {
    ...
    const deletedata = (_id) => {
        ...
        Apiservice.changeStatusSkill(data)
            .then((res) => {
                setTimeout(() => {
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-7">
                            <h1 className="text-white font-weight-bold">Manage Skills</h1>
                            <div className="custom-breadcrumbs">
                                <a href="#">Home</a> <span className="mx-2 slash">/</span>
                                <span className="text-white">
                                    <strong>Manage Skill</strong>
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12 bg-white p-5">
                            <h2 className="mb-4">Manage Skill</h2>
                                ...
                                <tbody>
                                    {skillsData?.map((el, index) => (
                                        <tr key={index} className="text-center">
                                            ...
                                            <td>
                                                <Link to={"/admin/updateSkill/" + el?._id}><button className="btn btn-info btn-sm mx-2">Edit</button></Link>
