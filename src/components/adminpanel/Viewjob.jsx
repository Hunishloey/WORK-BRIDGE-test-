        ...
        <div className="col-lg-8">
          ...
          <div className="mb-5">
            ...
            <ul className="list-unstyled m-0 p-0">
              ...
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>Front desk Executive</span>
              </li>
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>
              ...
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>
                We are seeking a skilled IT professional to manage.
                </span>
              </li>
            </ul>
          </div>
          <div className="mb-5">
            ...
            <ul className="list-unstyled m-0 p-0">
              ...
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>We are seeking a skilled IT professional to manage.</span>
              </li>
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>
          ...
          <div className="mb-5">
            ...
            <ul className="list-unstyled m-0 p-0">
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>Fully skilled with experience</span>
              </li>
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>
