      ...
      <div className="row">
        <div className="col-lg-8">
          <div className="mb-5">
            ...
            <p>
            We are seeking a skilled IT professional to manage, troubleshoot, and optimize systems, ensuring seamless operations. Strong problem-solving, technical expertise, and team collaboration skills required for success.
            </p>
            <p>
            We are seeking a skilled IT professional to manage, troubleshoot, and optimize systems, ensuring seamless operations. Strong problem-solving, technical expertise, and team collaboration skills required for success.
            </p>
          ...
          <div className="mb-5">
            ...
            <ul className="list-unstyled m-0 p-0">
              ...
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>
                We are seeking a skilled IT professional.
                </span>
              </li>
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
          ...
          <div className="mb-5">
            ...
            <ul className="list-unstyled m-0 p-0">
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>technical and communication skills</span>
              </li>
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>
              ...
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>We are seeking a skilled IT professional.</span>
              </li>
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>
              ...
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>
                We are seeking a skilled IT professional.                </span>
              </li>
            </ul>
          </div>
          <div className="mb-5">
            ...
            <ul className="list-unstyled m-0 p-0">
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>Front end and back end skills</span>
              </li>
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>
        ...
        <li className="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
          ...
          <div className="job-listing-about d-sm-flex custom-width w-100 justify-content-between mx-4">
            ...
            <div className="job-listing-meta">
              ...
              {/* <input type="button" value="Edit" style={{backgroundColor:"green",color:"white",marginRight:"10px",marginLeft:"10px",}}/>
              <input type="button" value="Delete" style={{backgroundColor:"green",color:"white",}}/> */}
            </div>
          </div>
        </li>
        <li className="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
    ...
    <div className="container">
      <div className="row">
        <div className="col-md-6 align-self-center text-center text-md-left mb-5 mb-md-0">
          ...
          We are seeking a skilled IT professional to manage, troubleshoot, and optimize systems, ensuring seamless operations. 
          </p>
          <p className="mb-0">
