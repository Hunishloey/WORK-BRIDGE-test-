export default function Job_hirer_viewjob(){
    return(
        <>
  {/* HOME */}
  <section
        ...
        <div className="col-lg-8">
          ...
          <div className="mb-5">
            ...
            <ul className="list-unstyled m-0 p-0">
              ...
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>Professional work schemes and learn with ease.</span>
              </li>
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>
                Professional work schemes and learn with ease.
                </span>
              </li>
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
          ...
          <div className="mb-5">
            ...
            <ul className="list-unstyled m-0 p-0">
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>Trips also available</span>
              </li>
              <li className="d-flex align-items-start mb-2">
                <span className="icon-check_circle mr-2 text-muted" />
                <span>
